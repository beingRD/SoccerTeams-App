...
void main() {
  test('test Team deserialization', () {
    const teamJSON =
        '{ "name": "Juventus", "url": "https://www.juvefc.com/wp-content/uploads/2019/08/FBL-ICC-2019-JUVENTUS-MADRID-1565462820.jpg","facts": [{"title": "History", "text": "Cristiano Ronaldo,\nPjanic,\nDybala,\nDe Ligt,\nBuffon,\nChilleni."}]}';
